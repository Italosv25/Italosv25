...
<!-- Typing SVG animado -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=6366F1&center=true&vCenter=true&width=600&lines=Ol%C3%A1%2C+sou+o+%C3%8Dtalo+Satler+%F0%9F%91%8B;Full-Stack+Developer;Engenharia+da+Computa%C3%A7%C3%A3o+%40+UVV)](https://git.io/typing-svg)

<p>
  Desenvolvedor Full-Stack freelance apaixonado por construir produtos digitais do zero.<br/>
  Estudante de Engenharia da Computação na <strong>UVV</strong> · Guarapari, ES, Brasil 🇧🇷
</p>
...
- 🎓 Cursando **Engenharia da Computação** (6º semestre) na UVV — Guarapari, ES
- 💼 Atuo como **freelancer Full-Stack**, entregando sistemas completos para clientes reais
- 🚀 Foco em aplicações web modernas: do banco de dados à interface final
